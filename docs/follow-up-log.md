...
- 挙動差分:
  ...
  - core fixture regression は formula basic / formula spill / chart basic / chart mixed / rich usecase / merge pattern fixture coverage subset を追加済み
...
- 未移植差分:
  - worksheet parser shared / cross-sheet formula fixture coverage expansion
...
- 次回の確認観点:
  ...
  - worksheet parser shared / cross-sheet formula fixture coverage をさらに広げる
